...
public class CatalogContext : DbContext
{
    ...
    public required DbSet<CatalogItemAssociation> CatalogItemAssociations { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.ApplyConfiguration(new CatalogItemAssociationEntityTypeConfiguration());
